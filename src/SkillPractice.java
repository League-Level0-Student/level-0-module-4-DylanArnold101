...
public class SkillPractice {
	...
	void skill1() {
		...
		String d = JOptionPane.showInputDialog("How much Gelts in your wallet? in dimes.");
		...
		if (high < 36) {
			JOptionPane.showMessageDialog(null, "Eat your stupid wheaties you motley fool");
		}

		else {
			JOptionPane.showMessageDialog(null, "You are a stupid jock");
		}
	}
